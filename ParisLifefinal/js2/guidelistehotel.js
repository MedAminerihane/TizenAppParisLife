function getidhotel(id){
	
	localStorage.setItem("guideitem",localStorage.getItem("hotel"+id));
...
window.addEventListener('load', function(){
    ...
    //alert(guidetype);
 	...
 	var service="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+localStorage.getItem("mypositionlat")+","+localStorage.getItem("mypositionlon")+"&rankby=distance&types=lodging&key=AIzaSyBF0ZDR7QPOhG0GD2vuQOdmt9akEk7lhMM"
 	var output = $.ajax({
	    ...
	    success: function(data) {
	    	...
	    	$.each(data.results, function(key, value) {
				...
				localStorage.setItem("hotel"+i, JSON.stringify(value));
				...
				*/
				...
				if(value.photos!=null){
					...
					var hotel ='<li class="ui-li-has-thumb" id="'+i+'"  onclick="getidhotel(this.id); return false;">'+
